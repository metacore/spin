...
TYPE
  ...
  Byte4 = BITS 32 FOR Word.T;
  Byte5 = BITS 32 FOR [0..16_fffffff];
...
PROCEDURE g(VAR x: Rec1; READONLY a: Rec1;
  ...
  BEGIN
    ...
    END;
    WITH b = VIEW(x, ARRAY [0..1] OF Byte) DO
    END;
    WITH b = VIEW(x, ARRAY [0..3] OF Byte) DO
    END;
    WITH b = VIEW(x, ARRAY [0..5] OF Byte) DO       (* bad *)
    END;
    
    WITH b = VIEW(x, BOOLEAN) DO                    (* bad *)
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..1] OF Byte; b: REF Word.T; END) DO                   (* bad *)
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..3] OF Byte; b: REF Word.T; END) DO
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..3] OF Byte; b: REF WordAlias; END) DO
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..1] OF [0..65535]; b: REF Word.T; END) DO
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..2] OF [0..65535]; b: REF BOOLEAN; END) DO            (* bad *)
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..1] OF [0..65535]; b: REF WordAlias; END) DO
    END;
    WITH b = VIEW(x, RECORD a: ARRAY [0..0] OF [0..65535]; b: REF Word.T; END) DO             (* bad *)
    END;
    WITH b = VIEW(a, RECORD a: ARRAY [0..1] OF [0..65535]; b: REF WordAlias; END) DO
    END;
    WITH b = VIEW(a, RECORD a: ARRAY [0..0] OF [0..65535]; b: REF WordAlias; END) DO          (* bad *)
    END;

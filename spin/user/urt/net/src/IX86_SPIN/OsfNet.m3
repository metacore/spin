...
MODULE OsfNet;
FROM Ctypes IMPORT int, unsigned_short, char_star, unsigned_char;
IMPORT OsfNetExtern;
IMPORT OsfNet, Mbuf, IO, Clock, SocketRep, SocketAddrIn,
       Protosw, Word, M3toC, Spy (*, StrongRef*);
IMPORT NetDev;
IMPORT Fmt;
...
PROCEDURE AddMultiAddr(
	<*UNUSED*>
	dev: NetDev.T;
	<*UNUSED*>
	VAR multiaddr: ARRAY[0..5] OF unsigned_char) =
  BEGIN
    IO.Put("ERROR: AddMultiAddr() doesn't work on x86, yet.\n");
  END AddMultiAddr;

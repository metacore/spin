 ...
 *	Does not need to import the Thread interface and use
 *	 Thread.Alerted.
 *
 * 23-Feb-96  Charles Garrett (garrett) at the University of Washington
 *	Added brand so TCP.T's can be put in tables. 
 *
 *)

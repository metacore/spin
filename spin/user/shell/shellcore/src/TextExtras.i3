...
(* FIXME: FUNCTIONAL *) PROCEDURE CIEqual(t, u: T): BOOLEAN RAISES {};
(* Return TRUE if t and u have the same length and the same
   (case-insensitive) contents. *)

(* FIXME: FUNCTIONAL *) PROCEDURE Compare(t, u: T): INTEGER RAISES {};
(* Result is <, =, > 0 accordingly as t is <, =, > u (ascii sort order) *)

(* FIXME: FUNCTIONAL *) PROCEDURE CICompare(t, u: T): INTEGER RAISES {};

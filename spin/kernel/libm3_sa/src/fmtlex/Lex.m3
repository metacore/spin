 ...
 *	Removed Float support for kernel services.
 *
 *)
...
<* UNUSED *> EXCEPTION IntOverflow(BOOLEAN);
...
<* UNUSED *> PROCEDURE ConcatDigits(READONLY d1, d2: ARRAY OF [0..9]): REF ARRAY OF [0..9] =

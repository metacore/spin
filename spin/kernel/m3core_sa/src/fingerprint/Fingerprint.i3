 ...
 *	use constant RTMachine.PreferredAlignment instead of 64
 *
 * 06-Mar-96  Wilson Hsieh (whsieh) at the University of Washington
 *	use ALIGNED 64 FOR for type T
 *
 *)
...
TYPE T = RECORD
    byte: ALIGNED RTMachine.PreferredAlignment FOR
...
CONST Zero = T{ALIGNED RTMachine.PreferredAlignment FOR
                 ARRAY [0..7] OF BITS 8 FOR [0..255] {0, ..}};

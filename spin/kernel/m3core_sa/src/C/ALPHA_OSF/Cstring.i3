 ...
 *      Some of these functions are no longer defined in the spin kernel,
 *      and since we don't want people using them, we have commented them
 *      out.
 *
 * 30-Oct-95  Charlie Garrett (garrett) at the University of Washington
 *	External C functions now have wrappers, implemented in
 *      Cstring.m3.
 *)

 ...
 *       and the local libs -- RTHooks.i3
 *
 * 25-Jan-96  Wilson Hsieh (whsieh) at the University of Washington
 *	support for SIZE fault (implicit exception generated by VIEW)
 *      added comment to list additional fault code
 *
 *)
...
(* the limits of the stack of the currently running thread.
...
(* report the runtime fault in the specified module.  "info" encodes
   ...
   Where the fault codes are:
     ...
     9 - stack overflow
    10 - SIZE fault in VIEW
    11 - ALIGNMENT fault in VIEW
*)
...
<* EXTERNAL *>
PROCEDURE TraceCount (tc: INTEGER (*RT0.Typecode*); definite: BOOLEAN);

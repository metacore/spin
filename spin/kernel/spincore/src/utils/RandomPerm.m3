...
(* Last modified on Mon May 31 15:39:17 PDT 1993 by swart      *)
(*      modified on Wed Sep  2 12:27:48 PDT 1992 by kalsow     *)
...
EXCEPTION ASSERT_FAILED; <*FATAL ASSERT_FAILED*>
...
PROCEDURE LQInit (t: LowQuality; n: CARDINAL; r: Random.T): LowQuality =
  ...
  BEGIN
    ...
    ELSE
      ...
      IF (bits > BITSIZE(INTEGER) - 2) THEN RAISE ASSERT_FAILED END;
      t.bits := bits;
    END;

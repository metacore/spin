 ...
 *	Enable dynamic value of of DECR_PC_AFTER_BREAK.
 *
 */
     ...
     int not_a_breakpoint;
{
  ...
  check_realbreakpoint = 1;
#else
  check_realbreakpoint = DECR_PC_AFTER_BREAK;
#endif  

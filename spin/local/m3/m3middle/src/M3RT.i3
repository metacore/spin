 ...
 *	FormalModeCVAR should be 3, not 2
 *	This doesn't really matter, since the value is never used to
 *	generate code, but it should be different from the other
 *      constants.
 *
 ...
 *	Added procedure type information. Added argument passing mode
 *	descriptors. 
 *
 * 13-Nov-95  Przemek Pardyak (pardy) at the University of Washington
 *	Changed to accomodate modifications of RT0.i3 for dynamic linking.
 *)
...
VAR (* typecell offsets *)
  ...
  TC_subTypeCode     : CARDINAL; (* : INTEGER *)
  TC_lastSubTypeCode : CARDINAL; (* : INTEGER *)
...
VAR (* offsets and size of an RT0.ModuleInfo record *)
  ...
  MI_proc_types     : CARDINAL; (* : ADDRESS *)

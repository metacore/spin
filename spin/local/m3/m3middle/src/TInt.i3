...
PROCEDURE BitwiseAnd (READONLY a, b: Int;  VAR i: Int): BOOLEAN;
(* returns 'Word.And(a, b)' *)

PROCEDURE BitwiseOr (READONLY a, b: Int;  VAR i: Int): BOOLEAN;
(* returns 'Word.Or(a, b)' *)

PROCEDURE Shift (READONLY a, b: Int;  VAR i: Int): BOOLEAN;

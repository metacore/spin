...
(*                                                             *)
(* Last modified on Tue Dec 20 13:55:13 PST 1994 by kalsow     *)
...
PROCEDURE declare_aligned (xx: T;  t: TypeUID; size, align: BitSize; 
                           base: TypeUID) =
  BEGIN
    xx.child.declare_aligned (t, size, align, base);
  END declare_aligned;
...
PROCEDURE get_runtime_hook (xx: T;  n: Name; VAR v: Var; VAR o: ByteOffset) =
  BEGIN
...
PROCEDURE check_size (xx: T;  READONLY i: Target.Int) =
  BEGIN
    xx.child.check_size (i);
  END check_size;

PROCEDURE check_align (xx: T;  READONLY i: Target.Int) =
  BEGIN
    xx.child.check_align (i);
  END check_align;
...
PROCEDURE pop_param (xx: T;  t: ZType) =
  BEGIN

...
(* File: PackedType.m3                                         *)
(* Last modified on Wed Sep  7 15:33:14 PDT 1994 by kalsow     *)
...
IMPORT M3Buf, Token, IntegerExpr, Scanner, TipeDesc, Fmt;
...
PROCEDURE ToText (p: P): TEXT =
  BEGIN
    RETURN ("BITS " & Fmt.Int(p.newSize) & " FOR " & p.baseType.to_text());
  END ToText;

...
(* File: UserProc.m3                                           *)
(* Last Modified On Tue Dec 20 15:21:41 PST 1994 By kalsow     *)
...
PROCEDURE Prep (ce: CallExpr.T) =
  ...
  BEGIN
    ...
    IF large_result AND
      ...
      GenResultArg (tmp_result, align_result);
    END;
    IF callConv.args_left_to_right THEN
...
PROCEDURE GenResultArg (tmp: CG.Var;  align: CG.Alignment) =
  BEGIN
    CG.Load_addr_of (tmp, 0, align);

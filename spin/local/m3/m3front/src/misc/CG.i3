...
(* File: CG.i3                                                 *)
(* Last modified on Tue Dec 20 14:17:03 PST 1994 by kalsow     *)
 ...
 *	added Check_align for VIEW alignment check
 *
...
(* IF (s0.I < i) THEN Abort END; pop *)

PROCEDURE Check_align (READONLY i: Target.Int);
(* IF (s0.I BITAND i) THEN Abort END; pop *)

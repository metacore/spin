...
(* File: Expr.m3                                               *)
(* Last Modified On Fri Feb 24 16:38:54 PST 1995 By kalsow     *)
...
PROCEDURE IsGlobal (t: T): M3.Global =
  BEGIN
    IF t = NIL THEN RETURN M3.Global.No; END;
    RETURN t.global ();
  END IsGlobal;
...
PROCEDURE NotGlobal (<* UNUSED *> t: T) : M3.Global =
  BEGIN
    RETURN M3.Global.No;
  END NotGlobal; 

...
(* File: ExprRep.i3                                            *)
(* Last Modified On Fri Feb 24 16:27:48 PST 1995 By kalsow     *)
...
PROCEDURE NoPrepLiteral  (e: M3.Expr;  type: M3.Type);
PROCEDURE NoLiteral      (e: M3.Expr;  offset: INTEGER;  type: M3.Type);
...
PROCEDURE NotGlobal (e: M3.Expr) : M3.Global;

...
(* HISTORY
 * 04-Apr-96  Charles Garrett (garrett) at the University of Washington
 *	Changed GetStamp to always set the unit variable. MxMerge.CheckStamps 
 *	relies on this being true. This fixes a problem Gun noticed where you
 *	could eliminate a symbol from an interface but the missing
 *	version stamp would not cause the users of the symbol to be recompiled.
 *
 *)

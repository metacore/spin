...
TYPE 
  ...
  E = {ADDRESS_, AND_, ANY_, ARRAY_, AS_,
       ...
       VALUE_, VAR_,
       WHILE_, WITH_, EPHEMERAL_, FUNCTIONAL_, PROCANY_,
       Identifier,
  ...
  ReservedWord = [E.ADDRESS_ .. E.PROCANY_];
...
CONST
  ...
  WITH_: T = ORD(E.WITH_);
  EPHEMERAL_: T = ORD(E.EPHEMERAL_);
  PROCANY_: T = ORD(E.PROCANY_);
  FUNCTIONAL_: T = ORD(E.FUNCTIONAL_);
...
CONST
  ReservedWordTexts = ARRAY ReservedWord OF TEXT{
      ...
      "WITH", "EPHEMERAL", "FUNCTIONAL", "PROCANY"};

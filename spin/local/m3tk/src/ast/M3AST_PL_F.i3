...
IMPORT M3AST_AS, M3AST_PL;
IMPORT SeqM3AST_AS_Module, SeqM3AST_AS_Proc_id, SeqM3AST_AS_Module_id,
    SeqM3AST_AS_Object_type;
IMPORT M3AST_TL_F AS Previous_View;

TYPE
   Interface_id = Previous_View.Interface_id OBJECT
     pl_isexportedby_s := SeqM3AST_AS_Module_id.Null;
     pl_missing_proc_s := SeqM3AST_AS_Proc_id.Null;
   END;

   Module = Previous_View.Module OBJECT
     pl_dependson_s := SeqM3AST_AS_Module.Null;
     pl_tmp_dep_status := 0;
     pl_tmp_init_status := 0;
   END;

   Object_type = Previous_View.Object_type OBJECT
     pl_subtype_s := SeqM3AST_AS_Object_type.Null;
     pl_method_table: MethodTable;
   END;

   MethodTable = M3AST_PL.MethodTable;

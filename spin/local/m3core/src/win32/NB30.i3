...
(* by Stephen Harrison                                       *)
(*                                                           *)
(* Last modified on Wed Dec 21 09:19:51 PST 1994 by kalsow   *)
...
CONST
  ...
  MAX_LANA = 32;                (* lana's in range 0 to MAX_LANA *)
...
TYPE
  ...
  NCB = RECORD
    ...
    ncb_callname: ARRAY [0 .. NCBNAMSZ - 1] OF UCHAR;  (* blank-padded
                                                            name of remote *)
    ncb_name: ARRAY [0 .. NCBNAMSZ - 1] OF UCHAR;  (* our blank-padded
                                                        netname *)
    ncb_rto: UCHAR;           (* rcv timeout/retry count *)
    ncb_sto: UCHAR;           (* send timeout/sys timeout *)
    ncb_post: PROCEDURE (arg: UNTRACED REF NCB);  (* POST routine
                                                       address *)
    ncb_lana_num: UCHAR;      (* lana (adapter) number *)
    ncb_cmd_cplt: UCHAR;      (* 0xff => commmand pending *)
    ncb_reserve: ARRAY [0 .. 10 - 1] OF UCHAR;  (* reserved, used by BIOS *)

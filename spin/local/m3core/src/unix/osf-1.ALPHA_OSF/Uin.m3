...
(*                                                                           *)
(* Last modified on Mon Apr 12 21:00:50 PDT 1993 by muller                   *)
...
FROM Utypes IMPORT u_int, u_short, u_char;
IMPORT Usocket, Word;
...
TYPE
  A = ALIGNED 32 FOR RECORD a, b, c, d: u_char; END;
  B = ALIGNED 32 FOR RECORD d, c, b, a: u_char; END;

  C = ALIGNED 16 FOR RECORD a, b: u_char; END;
  D = ALIGNED 16 FOR RECORD b, a: u_char; END;

...
CONST
  ...
  FNDELAY =    8_000004;        (* non-blocking I/O, O_NDELAY *)
                                (* in BSD mode this is O_NONBLOCK *)
  FAPPEND =    8_000010;        (* append on each write O_APPEND*)
  FDEFER =     8_020000;        (* deferred update O_DEFER*)
  FASYNC =     8_400000;        (* signal pgrp when data ready *)
  FCREAT =     8_000400;        (* create if nonexistant O_CREAT*)
  FTRUNC  =    8_001000;        (* truncate to zero length O_TRUNC*)
  FEXCL =      8_002000;        (* error if already created O_EXCL*)
  FSYNCRON =   8_000020;        (* write file syncronously O_SYNC*)
  FNBLOCK =    8_100000;        (* POSIX no delay O_NONBLOCK *)
  FNOCTTY =    8_004000;        (* do not assign control tty O_NOCTTY*)
(* Additional Open Modes *)
  FNONE =      8_000003;        (* open without read or write, O_NONE *)
  FEXEC =      8_000040;        (* open/close for exec O_EXEC *)
  FRSHARE =    8_010000;        (* read shared open O_RSHARE *)
  FDELAY =     8_040000;        (* deferred update O_DEFER *)
  FNSHARE =    8_200000;        (* read shared open, O_NSHARE *)
...
<*EXTERNAL*> PROCEDURE creat (name: char_star; mode: u_long): int;
...
CONST   (* request *)
  ...
  F_GETLK  = 5;   (* Get first blocking lock *)
  F_SETLK  = 6;   (* Non-blocking lock *)
  F_SETLKW = 7;   (* Blocking lock *)
  F_GETOWN = 8;   (* Get owner *)
  F_SETOWN = 9;   (* Set owner *)
  F_CLOSEM = 10;  (* Close multiple files *) 
...
<*EXTERNAL*> PROCEDURE mkdir (path: char_star; mode: u_long): int;
...
<*EXTERNAL*> PROCEDURE umask (numask: u_long): u_long;

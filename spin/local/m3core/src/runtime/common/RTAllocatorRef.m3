...
(*
 * HISTORY
 * 04-Feb-97  Wilson Hsieh (whsieh) at the University of Washington
 *	created
 *
 *)
...
IMPORT RTCollectorSpinExtern;  (* for reference counting *)
...
PROCEDURE Allocate (defn: ADDRESS): REFANY =
  ...
  BEGIN
    ...
    RTCollectorSpinExtern.AssignKnown (res, NIL);

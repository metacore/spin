...
/* need this hack to support cross compiling... */
#if HOST_FLOAT_WORDS_BIG_ENDIAN
  operands[5] = force_reg (DFmode, immed_double_const (0x43300000,
						       0x80000000, DFmode));
#else
  operands[5] = force_reg (DFmode, immed_double_const (0x80000000,
						       0x43300000, DFmode));
#endif
}")
...
#else
  operands[4] = force_reg (DFmode, immed_double_const (0, 0x43300000, DFmode));
#endif
}")
